...
@Component({
	selector: 'app-admin-solo-select-dropdown',
	templateUrl:
		'./admin-solo-select-dropdown.component.html',
	styleUrls: [
		'./admin-solo-select-dropdown.component.scss',
	],
	providers: [
		{
...
export class AdminSoloSelectDropdownComponent
	implements OnInit
{
	@Input() label = 'Search';
